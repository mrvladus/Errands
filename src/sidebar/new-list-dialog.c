...
static void errands_new_list_dialog_init(ErrandsNewListDialog *self) {
  ...
  adw_alert_dialog_set_response_appearance(ADW_ALERT_DIALOG(self), "create", ADW_RESPONSE_SUGGESTED);
...
void errands_new_list_dialog_show() {
  if (!state.new_list_dialog) state.new_list_dialog = errands_new_list_dialog_new();
