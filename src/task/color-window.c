...
static void errands_color_window_init(ErrandsColorWindow *self) {
  ...
  g_signal_connect(none_btn, "toggled",
                   G_CALLBACK(on_errands_color_window_color_select_cb), self);
  ...
  g_signal_connect(blue_btn, "toggled",
                   G_CALLBACK(on_errands_color_window_color_select_cb), self);
  ...
  g_signal_connect(green_btn, "toggled",
                   G_CALLBACK(on_errands_color_window_color_select_cb), self);
  ...
  g_signal_connect(yellow_btn, "toggled",
                   G_CALLBACK(on_errands_color_window_color_select_cb), self);
  ...
  g_signal_connect(orange_btn, "toggled",
                   G_CALLBACK(on_errands_color_window_color_select_cb), self);
  ...
  g_signal_connect(red_btn, "toggled",
                   G_CALLBACK(on_errands_color_window_color_select_cb), self);
  ...
  g_signal_connect(purple_btn, "toggled",
                   G_CALLBACK(on_errands_color_window_color_select_cb), self);
  ...
  g_signal_connect(brown_btn, "toggled",
                   G_CALLBACK(on_errands_color_window_color_select_cb), self);
  ...
  g_object_set(tb, "content", self->color_box, "margin-start", 12, "margin-end",
               12, "margin-bottom", 12, NULL);
...
void errands_color_window_show(ErrandsTask *task) {
  ...
  // Show dialog
  adw_dialog_present(ADW_DIALOG(state.color_window),
