...
G_DECLARE_FINAL_TYPE(ErrandsNewListDialog, errands_new_list_dialog, ERRANDS, NEW_LIST_DIALOG,
                     AdwAlertDialog)
...
G_DECLARE_FINAL_TYPE(ErrandsDeleteListDialog, errands_delete_list_dialog, ERRANDS,
