...
distrobox-create \
    ...
    --additional-packages "gcc make pkgconf git neovim zed curl libadwaita libportal-gtk4 libical libsecret gtksourceview5 blueprint-compiler clang flatpak-builder"
